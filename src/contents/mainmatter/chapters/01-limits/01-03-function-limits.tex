...
\begin{problem}{分段函数在原点处的极限}{Limits-Of-Piecewise-Functions-At-Zero}
    ...
    \begin{enumerate}
        ...
        \item $f(x) = \begin{cases} \cos \frac{1}{x}, & x > 0, \\ x, & x \leqslant 0. \end{cases}$
    \end{enumerate}
\end{problem}
...
\begin{solution}
    ...
    \end{equation}
    \begin{equation}
        \boxed{\lim_{n\to\infty} \cos \frac{x}{2} \cos \frac{x}{2^2} \cdots \cos \frac{x}{2^n} = \begin{cases} \frac{\sin x}{x}, & x \neq 0, \\ 1, & x = 0. \end{cases}}
    \end{equation}
\end{solution}
...
\begin{solution}
    ...
    由此可得：
    \begin{equation}
        \lim_{x\to +\infty} \frac{P_n(x)}{P_m(x)} = \begin{cases} \infty, & n > m, \\ \frac{c_n}{d_m}, & n = m, \\ 0, & n < m. \end{cases}
    \end{equation}
    \begin{equation}
        \boxed{
            \begin{aligned}
    ...
    考察比值极限：
    \begin{equation}
        \lim_{x\to +\infty} \frac{x^\alpha}{x^\beta} = \lim_{x\to +\infty} x^{\alpha - \beta} = \begin{cases} +\infty, & \alpha > \beta, \\ 1, & \alpha = \beta, \\ 0, & \alpha < \beta. \end{cases}
    \end{equation}
    \begin{equation}
        \boxed{
            \begin{aligned}
    ...
    考察比值极限：
    \begin{equation}
        \lim_{x\to +\infty} \frac{a^x}{b^x} = \lim_{x\to +\infty} \left( \frac{a}{b} \right)^x = \begin{cases} +\infty, & a > b, \\ 1, & a = b, \\ 0, & a < b. \end{cases}
    \end{equation}
    \begin{equation}
        \boxed{
            \begin{aligned}
