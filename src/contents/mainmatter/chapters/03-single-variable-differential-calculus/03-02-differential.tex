...
\begin{problem}{参数方程所确定函数的一阶与二阶导数}{Parametric-Function-Derivatives}
    ...
    \begin{enumerate}
        \item $\begin{dcases} x = \ln(1+t^2), \\ y = t - \arctan t; \end{dcases}$
        \item $\begin{dcases} x = t - \sin t, \\ y = 1 - \cos t; \end{dcases}$
        \item $\begin{dcases} x = \varphi \cos \varphi, \\ y = \varphi \sin \varphi; \end{dcases}$
        \item $\begin{dcases} x = \cos^3 \varphi, \\ y = \sin^3 \varphi. \end{dcases}$
    \end{enumerate}
\end{problem}
...
\begin{problem}{参数方程曲线的切线方程}{Parametric-Curve-Tangent-Lines}
    求下列曲线在已知点处的切线方程：
    \begin{enumerate}
        \item $\begin{dcases} x = \cos t, \\ y = \sin t \end{dcases}$ 在 $t = \frac{\uppi}{4}$ 处；
        \item $\begin{dcases} x = \frac{3t}{1+t^2}, \\ y = \frac{3t^2}{1+t^2} \end{dcases}$ 在 $t = 2$ 处．
    \end{enumerate}
\end{problem}
