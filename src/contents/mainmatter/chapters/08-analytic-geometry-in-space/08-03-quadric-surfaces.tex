...
\begin{solution}
    ...
    方程可写为 $\frac{x^2}{4} + \frac{1}{9}(y^2 + z^2) = 1$．由于 $y^2$ 与 $z^2$ 的系数相同，该曲面可由 $Oxy$ 平面上的椭圆绕 $x$ 轴旋转而成：
    \begin{equation}
        C: \begin{dcases} \frac{x^2}{4} + \frac{y^2}{9} = 1 \\ z = 0 \end{dcases} \implies \text{绕 } x \text{ 轴旋转}
    \end{equation}
    \begin{equation}
    ...
    \begin{equation}
        C: \begin{dcases} x^2 + z^2 = 1 \\ y = 0 \end{dcases} \implies \text{绕 } z \text{ 轴旋转}
    \end{equation}
    \begin{equation}
    ...
    方程可写为 $(x^2 + z^2) - \frac{y^2}{4} = 1$．由于 $x^2$ 与 $z^2$ 的系数相同，该曲面可由 $Oxy$ 平面上的双曲线绕 $y$ 轴旋转而成：
    \begin{equation}
        C: \begin{dcases} x^2 - \frac{y^2}{4} = 1 \\ z = 0 \end{dcases} \implies \text{绕 } y \text{ 轴旋转}
    \end{equation}
    \begin{equation}
    ...
    方程可写为 $x^2 - (y^2 + z^2) = 1$．由于 $y^2$ 与 $z^2$ 的系数相同，该曲面可由 $Oxy$ 平面上的双曲线绕 $x$ 轴旋转而成：
    \begin{equation}
        C: \begin{dcases} x^2 - y^2 = 1 \\ z = 0 \end{dcases} \implies \text{绕 } x \text{ 轴旋转}
    \end{equation}
    \begin{equation}
    ...
    方程中 $x^2$ 与 $y^2$ 的系数均为 $1$，该曲面可由 $Ozx$ 平面上的抛物线绕 $z$ 轴旋转而成：
    \begin{equation}
        C: \begin{dcases} x^2 = 4z \\ y = 0 \end{dcases} \implies \text{绕 } z \text{ 轴旋转}
    \end{equation}
    \begin{equation}
...
\begin{problem}{解析几何图形辨析}{Space-Analytic-Geometry}
    ...
    \begin{enumerate}
        ...
        \item $x^2 - y^2 = 1$;
        \item $y = x^2 + 1$;
        \item $\begin{dcases} 5x - y + 1 = 0, \\ 2x - y - 3 = 0; \end{dcases}$
        \item $\begin{dcases} \dfrac{x^2}{4} + \dfrac{y^2}{9} = 1, \\ y = 2; \end{dcases}$
        \item $\begin{dcases} \dfrac{x^2}{4} - \dfrac{y^2}{9} = 1, \\ x = 4. \end{dcases}$
    \end{enumerate}
\end{problem}
...
\begin{solution}
    ...
    联立方程组：
    \begin{equation}
        \begin{dcases} 5x - y + 1 = 0 \\ 2x - y - 3 = 0 \end{dcases} \implies 3x + 4 = 0 \implies \begin{dcases} x = -\dfrac{4}{3} \\ y = -\dfrac{17}{3} \end{dcases}
    \end{equation}
...
\begin{problem}{旋转曲面}{Surface-of-Revolution}
    求下列旋转曲面的方程，并指出它们的名称.
    \begin{enumerate}
        \item 曲线 $\begin{dcases} y^2 - \frac{z^2}{4} = 1, \\ x = 0 \end{dcases}$ 绕 $z$ 轴旋转一周;
        \item 曲线 $\begin{dcases} y = \sin x \, (0 \le x \le \uppi), \\ z = 0 \end{dcases}$ 绕 $x$ 轴旋转一周;
        \item 曲线 $\begin{dcases} 4x^2 + 9y^2 = 36, \\ z = 0 \end{dcases}$ 绕 $y$ 轴旋转一周.
    \end{enumerate}
\end{problem}
...
\begin{solution}
    设旋转轴为 $L$，其方程为 $\begin{dcases} x = 0 \\ y - z = 0 \end{dcases}$，方向向量为 $\symbfit{s} = (0, 1, 1)$．\\
    设母线为 $G$，其方程为 $\begin{dcases} x = 0 \\ y - 2z + 1 = 0 \end{dcases}$．\\
...
\begin{solution}
    ...
    \begin{equation}
        \boxed{L_0 : \begin{dcases} x - y + 2z - 1 = 0 \\ x - 3y - 2z + 1 = 0 \end{dcases}}
    \end{equation}
...
\begin{solution}
    ...
    此截痕在 $Oxy$ 平面上是双曲线．
    \begin{equation}
        \boxed{\begin{dcases} \dfrac{x^2}{9} - \dfrac{y^2}{9} = 1 \\ z = 0 \end{dcases}}
    \end{equation}
    ...
    此截痕在 $Ozx$ 平面上是双曲线．
    \begin{equation}
        \boxed{\begin{dcases} \dfrac{x^2}{9} - \dfrac{z^2}{9} = 1 \\ y = 0 \end{dcases}}
    \end{equation}
    ...
    \begin{equation}
        \boxed{\begin{dcases} y^2 + z^2 = 16 \\ x = 5 \end{dcases}}
    \end{equation}
\end{solution}
...
\begin{problem}{球面方程}{Sphere-Equation}
    已知一球面经过点 $(0, -3, 1)$ 且与 $Oxy$ 平面交成圆周 $\begin{dcases} x^2 + y^2 = 16 \\ z = 0 \end{dcases}$，试求其方程.
\end{problem}
...
\begin{solution}
    ...
    \begin{equation}
        \boxed{\begin{dcases} \frac{(x-12)^2}{260} + \frac{y^2}{13} = 1 \\ z = 0 \end{dcases}}
    \end{equation}
\end{solution}
...
\begin{solution}
    ...
    利用截口法研究其图形如下：
    \begin{itemize}
        \item \textbf{水平截口}：用平面 $z = k$ 截曲面，得截线为 $\begin{dcases} xy = k \\ z = k \end{dcases}$．当 $k \neq 0$ 时为等轴双曲线，当 $k$ 由正变负时，双曲线的实轴方向发生 $90^\circ$ 转向；当 $k = 0$ 时为两条交于原点的直线．
        \item \textbf{铅直截口}：用平面 $x = a$ 截之，得直线 $\begin{dcases} z = ay \\ x = a \end{dcases}$；用平面 $y = b$ 截之，得直线 $\begin{dcases} z = bx \\ y = b \end{dcases}$．说明该曲面是由两族直线构成的直纹面．
