...
\begin{problem}{球的参数方程}{Sphere-Parametric-Equation}
    ...
    \begin{equation}
        \begin{dcases}
            ...
            y = a \sin u \sin v, \\
            z = a \cos u,
        \end{dcases} \quad u \in [0, \uppi], v \in [0, 2\uppi)
    \end{equation}
...
\begin{solution}
    ...
    验证成立．故其参数方程为：
    \begin{equation}
        \boxed{\begin{dcases} x = a \sin \varphi \cos \theta \\ y = b \sin \varphi \sin \theta \\ z = c \cos \varphi \end{dcases} \quad (\varphi \in [0, \uppi], \theta \in [0, 2\uppi))}
    \end{equation}
\end{solution}
...
\begin{solution}
    ...
    \begin{equation}
        \boxed{\begin{dcases} x = \pm a \cosh t \\ y = b \sinh t \end{dcases} \quad (t \in \symbb{R})}
    \end{equation}
\end{solution}
...
\begin{solution}
    ...
    \begin{equation}
        \boxed{\begin{dcases} x = a \cosh u \cos v \\ y = b \cosh u \sin v \\ z = c \sinh u \end{dcases} \quad (u \in \symbb{R}, v \in [0, 2\uppi))}
    \end{equation}
    ...
    \begin{equation}
        \boxed{\begin{dcases} x = a \sinh u \cos v \\ y = b \sinh u \sin v \\ z = \pm c \cosh u \end{dcases} \quad (u \in [0, +\infty), v \in [0, 2\uppi))}
    \end{equation}
\end{solution}
