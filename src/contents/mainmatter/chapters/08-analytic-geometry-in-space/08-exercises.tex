...
\begin{problem}{柱面方程}{Cylinder-Equation}
    求准线为 $\begin{dcases} y^2 + z^2 = 1, \\ x = 1, \end{dcases}$ 母线方向为 $(2, 1, 1)$ 的柱面的一般方程.
\end{problem}
...
\begin{problem}{锥面方程}{Cone-Equation}
    求准线为 $\begin{dcases} y^2 + z^2 = 1, \\ x = 1, \end{dcases}$ 顶点坐标为 $(2, 1, 1)$ 的锥面的一般方程.
\end{problem}
...
\begin{solution}
    ...
    \begin{equation}
        \boxed{\begin{dcases}
            ...
            z = u
        \end{dcases} \quad (u \in \symbb{R}, v \in [0, 2\uppi))}
    \end{equation}
\end{solution}


\begin{problem}{旋转面方程}{Surface-Of-Revolution-2}
    求圆 $\begin{dcases} (x - 2)^2 + y^2 = 1, \\ z = 0 \end{dcases}$ 绕 $y$ 轴旋转所得旋转面的参数方程和一般方程．
\end{problem}
...
\begin{solution}
    ...
    \begin{equation}
        \boxed{\begin{dcases}
            ...
            y = \sin u              \\
            z = (2 + \cos u) \sin v
        \end{dcases} \quad (u, v \in [0, 2\uppi))}
    \end{equation}
\end{solution}
